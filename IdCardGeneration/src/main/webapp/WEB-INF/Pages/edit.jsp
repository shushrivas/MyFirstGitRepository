...
<body>
	<form:form class="form-horizontal" modelAttribute="studForm" action="saveInfo" method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<form:input id="studName" name="studName" path="studName" type="text"
						placeholder="Enter the name " class="form-control input-md"></form:input>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
				<form:input id="studAddress" name="studAddress" path="studAddress" type="text"
						placeholder="Enter the Address " class="form-control input-md"></form:input>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<form:input id="studMobileNumber" path="studMobileNumber" name="studMobileNumber" type="text"
